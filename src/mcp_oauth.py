...
Registration, authorization-code + PKCE, token refresh) to Ariadne's web
...
# on Ariadne. APP_PORT is intentionally not used: it is only the Docker host
