        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    ...
                    "reminder_minutes": {"type": "integer", "description": "For create_event: create an Ariadne reminder this many minutes before the event, e.g. 5 for 'reminder 5 min before'."},
